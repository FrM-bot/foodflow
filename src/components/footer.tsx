      ...
      <Container className="text-center">
        ...
        <div className="mt-3">
          <p className="text-gray-500 dark:text-neutral-500">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Earum commodi quaerat necessitatibus. Asperiores repellendus
            libero beatae doloremque ducimus alias magnam minima reprehenderit nemo qui neque quam nihil, odio voluptate saepe!
          </p>
        </div>
