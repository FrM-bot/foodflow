  ...
  return (
    <Card>
      <form className="max-w-xl mx-auto w-full">
        <div className="mb-6">
          <Typography size="subtitle">Editar mozo</Typography>
          <p className="text-sm text-muted-foreground">Complete todos los campos para editar el mozo.</p>
        </div>
...
export default function EditWaiterPage() {
  return (
    <DashboardContainer title="Editar mozo">
      <div>
